...
class Log_EweiShopV2Page extends AppMobilePage
{
	public function get_list()
	{
		...
		return app_json(array('list' => $newList, 'total' => $total, 'pagesize' => $psize, 'home' => $pindex, 'type' => $type, 'isopen' => $_W['shopset']['trade']['withdraw'], 'moneytext' => $_W['shopset']['trade']['moneytext']));
	}
}
