...
class Shop_EweiShopV2Page extends AppMobilePage
{
	...
	public function get_recommand()
	{
		global $_W;
		global $_GPC;
		$args = array('home' => $_GPC['home'], 'pagesize' => 10, 'isrecommand' => 1, 'order' => 'displayorder desc,createtime desc', 'by' => '');
		...
		return app_json(array('list' => $recommand['list'], 'pagesize' => $args['pagesize'], 'total' => $recommand['total'], 'home' => intval($_GPC['home'])));
	}
