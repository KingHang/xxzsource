...
//        20 => 'pages/goods/detail/detail',
    ...
    public function getImage()
    {
        ...
        // 下载商品首图
        $productUrl = $this->saveTempImage($appId, $this->product['brand']['image']['file_path'], 'goods');
        ...
        if($this->source == 'wx'){
            ...
            $scene = "gid:{$this->product['sign_id']},uid:" . ($this->user_id ?: '');
            $qrcode = new QrCode(base_url().'h5/pages/goods/detail/detail?product_id='.$this->product['sign_id'].'&app_id='.$appId.'&referee_id='.$this->user_id ?: '');
