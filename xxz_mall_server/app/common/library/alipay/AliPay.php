...
class AliPay
{
    ...
    public function return()
    {
        ...
        if ($source == 0) {
            ...
            // 人脸app下单
            $PaySuccess = facePayTypeSuccessFactory::getFactory($_GET['out_trade_no'], json_decode($attach, true));
        }
    ...
    public function notify()
    {
        ...
        $pay_source = isset($_POST['pay_source']) ? $_POST['pay_source'] : 0;
        $multiple = isset($_POST['ple']) ? $_POST['ple'] : 0;
        ...
        if ($source == 0) {
            ...
            // 人脸app下单
            $PaySuccess = facePayTypeSuccessFactory::getFactory($params['out_trade_no'], json_decode($attach, true));
        }
        ...
        if ($source == 0) {
            ...
            $ztData['data'] = json_encode($params);
