...
class Favorite extends BaseModel
{
    ...
    public function getMySupplier($where,$param){
        ...
        foreach ($list as $key => &$value) {
           ...
           //获取最新上架商品
            $productList = $product_model->with(['image.file'])->where(['product_status'=>10,'shop_supplier_id'=>$value['shop_supplier_id'],'audit_status'=>10,'is_delete'=>0])->field("product_name,product_id,sales_initial,sales_actual,product_price,line_price,product_type,shop_supplier_id")->order('product_id desc')->limit(3)->select();
