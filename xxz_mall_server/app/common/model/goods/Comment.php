...
class Comment extends BaseModel
{
    ...
    {
        return $this->belongsTo('app\\common\\model\\order\\OrderGoods');
    }
    ...
    {
        return $this->belongsTo('app\\common\\model\\goods\\Goods', 'goods_id', 'goods_id');
    }
    ...
    {
        return $this->hasMany('app\\common\\model\\goods\\CommentImage', 'comment_id', 'comment_id')->order(['id' => 'asc']);
    }
