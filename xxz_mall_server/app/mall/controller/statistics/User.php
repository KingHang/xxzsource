...
use app\mall\service\statistics\UserService;
use app\mall\service\statistics\UserRankingService;
...
class User extends Controller
{
    ...
    public function index()
    {
        return $this->renderSuccess('', [
            ...
            // 积分排行top10
            'pointsRanking' => (new UserRankingService())->getUserRanking('exchangepurch'),
            // 邀请人排行top10
     ...
     * 签到数
     */
    public function sign_user($search_time)
    {
        $days = $this->getDays($search_time);
        return $this->renderSuccess('', [
            // 日期
            'days' => $days,
            // 数据
            'data' => (new UserService())->getSignUserByDate($days),
        ]);
    }
