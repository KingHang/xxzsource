...
namespace app\mall\controller\file;

use app\XxzController;
use app\mall\model\file\UploadFile as UploadFileModel;
use app\mall\model\file\UploadGroup as UploadGroupModel;

class File extends XxzController
{
    /**
     * 文件库列表
     */
