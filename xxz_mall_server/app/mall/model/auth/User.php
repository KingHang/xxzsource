...
class User extends UserModel
{
    ...
    public function getUserName($where, $mall_user_id = 0)
    {
        if ($mall_user_id > 0) {
            return $this->where($where)->where('mall_user_id', '<>', $mall_user_id)->count();
        }
    ...
    public function edit($data)
    {
        ...
        try {
            ...
            $where['mall_user_id'] = $data['mall_user_id'];
