...
class Homepurveyor extends PageSupplierModel
{
    ...
    private function getSeckillList($item,$shop_supplier_id)
    {
        ...
        if ($seckill) {
            ...
            $seckill['product_list'] = $product_model->getProductList($seckill['seckill_activity_id'], $item['params']['showNum'],$shop_supplier_id)->toArray();
    ...
    private function getAssembleList($item,$shop_supplier_id)
    {
        ...
        if ($assemble) {
            ...
            $product_list = $product_model->getProductList($assemble['assemble_activity_id'], $item['params']['showNum'],$shop_supplier_id)->toArray();
    ...
    private function getBargainList($item,$shop_supplier_id)
    {
        ...
        if ($bargain) {
            ...
            $bargain['product_list'] = $product_model->getProductList($bargain['bargain_activity_id'], $item['params']['showNum'],$shop_supplier_id)->toArray();
