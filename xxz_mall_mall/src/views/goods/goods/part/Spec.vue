  ...
  <div class="basic-setting-content pl16 pr16">
    ...
    <el-form-item label="产品规格：">
      <el-radio-group v-model="form.model.spec_type">
        <el-radio v-if="!form.isSpecLocked || (form.isSpecLocked && form.model.spec_type === 10)" :label="10">单规格</el-radio>
        <el-radio v-if="!form.isSpecLocked || (form.isSpecLocked && form.model.spec_type === 20)" :label="20">多规格</el-radio>
      </el-radio-group>
