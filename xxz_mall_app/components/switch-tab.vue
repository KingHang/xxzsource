<template>
	<view class="switch-tab" :style="{background: bgColor}">
		<view :id="id">
			<view class="tab-block">
				<view v-for="(item, index) in list" :key="index" :class="['tab', index==current?'active':'']" @tap="clickTab(index)">
					{{ item[name] || item['name']}}
					<view v-if="index==current" class="point"></view>
				</view>
			</view>
		</view>
	</view>
