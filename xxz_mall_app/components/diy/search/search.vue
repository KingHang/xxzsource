<template>
    ...
    <view style="padding: 15rpx">
        <u-search  @click="gotoSearch" border-color="#F63E36" :disabled="true"   :show-action="true" action-text="搜索"  :animation="true" shape="round" search-icon="search" ></u-search>
    </view>

	<!--<view class="index-search-box" id="searchBox" style="display: none">
