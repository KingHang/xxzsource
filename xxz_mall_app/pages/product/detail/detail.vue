<template>
	<view class="product-detail pr">
		...
		<scroll-view scroll-y="true" class="scroll-Y scroll-box" :style="'height:' + scrollviewHigh + 'px;'"
				...
				<view class="price-wrap">
					<view class="d-s-s d-c ww100">
						<view class="d-s-c pr ww100 mb16">
							...
							<view class="sc-box" @click="favorite()">
								<text
									:class="isfollow == 0?'icon iconfont icon-shoucang gray3':'icon iconfont icon-shoucang red'"></text>
							</view>
						</view>
						<view>
			...
			<view class="product-content">
				...
				<view v-if="detail.is_picture == 1" class="content-box">
					<view v-for="(item, index) in detail.contentImage" :key="index">
		...
		<view class="btns-wrap">
			...
			<template>
				<button v-if="!room_id==true && !is_virtual" type="primary" class="add-cart"
