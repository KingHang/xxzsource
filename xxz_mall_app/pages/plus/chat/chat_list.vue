<template>
	<view class="im_index">
		<view class="im_item" v-for="(item,index) in imList" :key="index" @click="jumpPage(item.supplier_user_id,item.shop_supplier_id,item.supplier.name)">
			...
			<view class="im_item_right">
				<view class="im_item_right_item">
					<view class="title">{{item.supplier.name}}</view>
