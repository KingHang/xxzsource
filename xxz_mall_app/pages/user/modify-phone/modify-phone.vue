			...
			<view class="group-bd">
				...
				<view class="form-level d-s-c">
					...
					<view class="val flex-1 d-b-c">
                        ...
                        <block v-if="formData.mobile==''">
                            <button style="background-color: white;color: #C9C9C9;font-size: 24rpx" class="" type="default" @click="sendCode" :disabled="is_send">{{ send_btn_txt }}</button>

                        </block>
                        <block v-else>
                            <button style="background-color: white;color: #F63E36;font-size: 24rpx" class="" type="default" @click="sendCode" :disabled="is_send">{{ send_btn_txt }}</button>
...
<!--
        ...
        <view class="bottom-btn" @tap="formSubmit()">提交</view>
