		...
		<form @submit="formSubmit" @reset="formReset">
			...
			<view class="group bg-white">
				...
				<view class="d-s-c p-20-0">
					<button v-if="product.orderM.delivery_type.value!=30" type="default" :class="type==10?'btn-red-border':''" @click="tabType(10)">退货/退款</button>
					<button v-if="product.orderM.delivery_type.value!=30" type="default" :class="type==20?'ml20 btn-red-border':'ml20'" @click="tabType(20)">换货</button>
					<button v-if="product.orderM.delivery_type.value==30" type="default" :class="type==30?'ml20 btn-red-border':'ml20'" @click="tabType(30)">仅退款</button>
				</view>
			</view>
