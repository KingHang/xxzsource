	...
	export default {
          ...
          self._get(
              ...
              function(res) {
				...
				// 积分兑换结算
					...
					self._get(
						'plugin.exchangepurch.order/buy', {
							params: JSON.stringify(
								Object.assign({}, params, {
			...
			closeDistFunc(e) {
				...
				self.store_data[storid].store_id = self.extract_store.store_id;
      ...
      SubmitOrder() {
        ...
        if (self.exist_address) {
          ...
          if (self.options.order_type === 'deposit') {
            url = 'plugin.advance.Order/frontBuy';
            params = Object.assign(params, {
              product_id: self.options.product_id,
              product_num: self.options.product_num,
              product_sku_id: self.options.product_sku_id,
