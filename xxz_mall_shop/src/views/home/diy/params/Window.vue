  ...
  <div>
    ...
    <el-form size="small" :model="curItem" label-width="100px">
      ...
      <el-form-item label="上下边距：">
        <el-slider v-model="curItem.style.paddingTop" show-input />
      </el-form-item>

      <!--左右边距-->
      <el-form-item label="左右边距：">
        <el-slider v-model="curItem.style.paddingLeft" :min="0" :max="50" show-input />
      </el-form-item>
      ...
      <el-form-item label="图片：">
        <div v-for="(imageSingle, indexTemp) in curItem.data" :key="indexTemp" class="param-img-item">
          <div class="delete-box"><i class="el-icon-delete-solid" @click="$parent.onEditorDeleleData(indexTemp, selectedIndex)" /></div>
          ...
          <div class="d-s-c">
            <div class="url-box flex-1">
              ...
              <el-input v-model="imageSingle.name" />
            </div>
