  ...
  <div class="product-add">
    ...
    <el-form ref="form" size="small" :model="form" :rules="formRules" label-width="200px">
      ...
      <el-form-item label="配送区域及运费">
        ...
        <div><el-button type="text" size="small" @click="addAreaClick">+点击添加可配送区域和运费</el-button></div>
      </el-form-item>
      ...
      <!--提交-->
      <div class="common-button-wrapper"><el-button type="primary" :loading="loading" @click="onSubmit">提交</el-button></div>
    </el-form>

    <!--区域 -->
    <Areas v-if="show_area" :show_area="show_area" :area-model="areaModel" :areas="options" @closeArea="closeAreaFunc" />
  </div>
</template>
