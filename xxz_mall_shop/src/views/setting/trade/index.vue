  ...
  <div class="product-add">
    ...
    <el-form ref="form" size="small" :model="form" label-width="150px">
      ...
      <el-form-item label="未支付订单">
        <el-input v-model="form.close_days" type="number" style="width: 200px;" />
        天后自动关闭
        <div class="tips">
      ...
      <el-form-item label="已发货订单">
        <el-input v-model="form.receive_days" type="number" style="width: 200px;" />
        天后自动确认收货
        <div class="tips">
      ...
      <el-form-item label="已完成订单">
        <el-input v-model="form.refund_days" type="number" style="width: 200px;" />
        天内允许申请售后
        <div class="tips">
